...
fn test_callback() {
    ...
    */
    ...
    let box_token_ids: Vec<String> = vec!["2:2".to_string(),"3:2".to_string(),"4:2".to_string(),"5:2".to_string(),"6:2".to_string(),
    "7:2".to_string()];
    out_come = call!(
        user,
    ...
    //
    // 7.5 mint 4 TYPE-S SPACESHIPs of owner account and list TYPE-S SPACESHIP
    //
    println!("------------------------------ 7.5.2 -------------------------------");
    out_come = call!(
        owner,
        spaceship.mint_by_types(owner.account_id(), 5, 1),
        //deposit = 1
        gas = near_sdk_sim::DEFAULT_GAS
    );
    out_come.assert_success();
    ...
    out_come = call!(
        owner,
        spaceship.mint_by_types(owner.account_id(), 5, 2),
        //deposit = 1
        gas = near_sdk_sim::DEFAULT_GAS
    );
    out_come.assert_success();
    ...
    out_come = call!(
        owner,
        spaceship.mint_by_types(owner.account_id(), 5, 3),
        //deposit = 1
        gas = near_sdk_sim::DEFAULT_GAS
    );
    out_come.assert_success();
    ...
    out_come = call!(
        owner,
        spaceship.mint_by_types(owner.account_id(), 5, 4),
        //deposit = 1
        gas = near_sdk_sim::DEFAULT_GAS
    );
    out_come.assert_success();
    ...
    out_come = call!(
        owner,
        spaceship.nft_tokens_for_owner(owner.account_id(), Some(U128(0)), Some(1000)),
        //deposit = 1
        gas = near_sdk_sim::DEFAULT_GAS
    );
    out_come.assert_success();
